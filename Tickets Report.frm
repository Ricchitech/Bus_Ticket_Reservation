...
Begin VB.Form Form12 
   Caption         =   "Reserved Tickets Reports"
   ClientHeight    =   10635
   ClientLeft      =   225
   ClientTop       =   870
   ClientWidth     =   20250
   Icon            =   "Tickets Report.frx":0000
   LinkTopic       =   "Form12"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "Tickets Report.frx":424A
   ScaleHeight     =   10635
   ScaleWidth      =   20250
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "Tickets Report.frx":3179C
      Height          =   9135
      Left            =   0
      TabIndex        =   0
      Top             =   0
      ...
      BeginProperty Column13 
         DataField       =   "Passenger_Type"
         Caption         =   "Passenger_Type"
         BeginProperty DataFormat {6D835690-900B-11D0-9484-00A0C91110ED} 
            Type            =   0
            Format          =   ""
            HaveTrueFalseNull=   0
...
Adodc1.RecordSource = "select * from Ticket where S2D ='" & Combo1 & "'"
Adodc1.Refresh
If Adodc1.Recordset.RecordCount = 0 Then
MsgBox "No Reservations Found"
End If
End Sub

Private Sub Form_Load()
Adodc1.RecordSource = "select * from Ticket"
Adodc1.Refresh
If Adodc1.Recordset.RecordCount = 0 Then
MsgBox "No Reservations Found"
Else
